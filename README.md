...
## Note
 - In my area, rainfall estimates using the following coefficients gave R<sup>2</sup> = 0.97 with hourly rainfall (mm/h) from a tipping bucket rain gauge 20 metres away.
